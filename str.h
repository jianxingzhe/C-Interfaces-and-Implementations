...
extern char *Str_reserve(const char *s,int i,int j);
...
extern int Str_char  (const char *s,int i,int j,int c);
...
extern int Str_any   (const char *s,int i,int j,const char *set);
...
extern void Str_fmt(int code,va_list *app,int put(int c,void *cl),void *cl,
